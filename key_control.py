...
class DroneController:
    ...
    def __init__(self):
        ...
        self.max_speed = 0.5#5.0 #6.0
        self.angular_velocity = 25 #90.0
        self.duration = 0.5
        self.durationfor = 0.05 # 0.4
        self.friction = 0.5
        ...
        self._client = airsim.MultirotorClient(settings.ip)
    ...
    def _handle_commands(self):
        ...
        if self._active_commands["forward"] or self._active_commands["backward"]:
            forward_increment = forward_direction * self.durationfor * self.acceleration
